...
const positiveWords: Record<string, number> = {
  ...
  generous: 1.3, gorgeous: 1.5, graceful: 1.3, honest: 1.2, inspiring: 1.5,
  ...
  sweet: 1.2, thankful: 1.3, thoughtful: 1.2, vibrant: 1.3, warm: 1.1,
  welcoming: 1.2, wise: 1.1, worthy: 1.1, incredible: 1.8, splendid: 1.7,
...
const negativeWords: Record<string, number> = {
  ...
  despicable: 1.8, detestable: 1.8, disastrous: 1.8, dreadful: 1.7,
  ...
  inept: 1.4, inferior: 1.3, insecure: 1.1, irresponsible: 1.4,
  ...
  try {
    ...
    const { data: inserted, error: dbError } = await supabase
      ...
      .insert({
        ...
        positive_score: ensemble.positive_score,
        negative_score: ensemble.negative_score,
        neutral_score: ensemble.neutral_score,
        keywords: tfidfResult.keywords,
        word_count: tfidfResult.word_count,
